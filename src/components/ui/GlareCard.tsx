...
export const GlareCard = memo(({
  ...
  const updateStyles = useCallback(() => {
    if (refElement.current) {
      ...
      const style = refElement.current.style;
      style.setProperty("--m-x", `${glare.x}%`);
      style.setProperty("--m-y", `${glare.y}%`);
      style.setProperty("--r-x", `${rotate.x}deg`);
      style.setProperty("--r-y", `${rotate.y}deg`);
      style.setProperty("--bg-x", `${background.x}%`);
      style.setProperty("--bg-y", `${background.y}%`);
    }
  }, []);
  ...
  const handlePointerLeave = useCallback(() => {
    ...
    if (refElement.current) {
      ...
      style.setProperty("--r-x", "0deg");
      style.setProperty("--r-y", "0deg");
    }
  }, []);
