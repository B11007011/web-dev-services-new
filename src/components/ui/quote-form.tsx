      ...
      <div className="relative w-full max-w-md bg-[#0B1120] rounded-lg shadow-2xl border border-gray-800">
        ...
        <div className="p-5">
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            ...
            <button
              type="submit"
              className="w-full px-4 py-2 bg-gradient-to-r from-blue-600 via-purple-600 to-blue-600 text-white rounded-md hover:opacity-90 transition-all duration-300 text-sm font-medium hover:shadow-lg hover:shadow-purple-500/20"
            >
              Submit Request
            </button>
          </form>
