  ...
  const features = [
    {
      ...
      description: 'Built with Next.js, React, and TypeScript for optimal performance',
      icon: (
    ...
    },
    {
      ...
      description: 'Optimized for speed with modern web performance techniques',
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    {
      title: 'Analytics',
      description: 'Integrated analytics to track and improve performance',
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  return (
    <section className="py-20 bg-white" id="features">
      <div className="container mx-auto px-4">
        <h2 className="text-4xl font-bold text-center mb-12">Technical Features</h2>
